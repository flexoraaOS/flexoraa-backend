-- =====================================================
-- FLEXORAA TEAM MEMBERS TABLE MIGRATION
-- =====================================================
-- Description: Creates the team_members table for team management
-- Created: 2025-01-20
-- =====================================================
...
DROP POLICY IF EXISTS "Users can view team members they invited" ON public.team_members;
...
DROP POLICY IF EXISTS "Users can insert team members they invite" ON public.team_members;
CREATE POLICY "Users can insert team members they invite" 
ON public.team_members 
FOR INSERT 
WITH CHECK (auth.uid() = invited_by);

DROP POLICY IF EXISTS "Users can update team members they invited" ON public.team_members;
CREATE POLICY "Users can update team members they invited" 
ON public.team_members 
FOR UPDATE 
USING (auth.uid() = invited_by);

DROP POLICY IF EXISTS "Users can delete team members they invited" ON public.team_members;
...
DROP TRIGGER IF EXISTS handle_updated_at ON public.team_members;
