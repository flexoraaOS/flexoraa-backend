...
const PricingTiers: React.FC<PricingTiersProps> = ({ title, description, plans }) => (
  <div className="min-h-screen bg-background py-16 p-4 md:px-5 lg:px-20 sm:px-0">
    ...
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-5 items-center max "
    >
      {plans.map((plan) => (
