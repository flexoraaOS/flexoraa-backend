...
const AgentosDashboardHeader: React.FC<DashboardHeaderProps> = ({ title, children }) => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <Button variant="outline" asChild className="w-full sm:w-auto">
          <Link href="/dashboard/ai-persona" className="flex items-center">
        ...
        <Button className="gradient-background text-primary-foreground hover:opacity-90 w-full sm:w-auto" asChild>
          <Link href="/dashboard/upload-leads" className="flex items-center">
